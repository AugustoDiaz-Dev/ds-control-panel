...
class TestTrainEndpoint:
    ...
    def test_train_endpoint_success(self, client, sample_training_params):
    ...
    def test_train_endpoint_with_catboost(self, client):
        ...
        response = client.post("/train", params=params)
        assert response.status_code == status.HTTP_200_OK
    
    def test_train_endpoint_custom_params(self, client):
...
class TestPredictEndpoint:
    ...
    def test_predict_without_trained_models(self, client, sample_features):
    ...
    def test_predict_with_trained_models(self, client, sample_training_params, sample_features):
    ...
    def test_predict_with_specific_model(self, client, sample_training_params, sample_features):
    ...
    def test_predict_invalid_features(self, client, sample_training_params):
...
class TestMetricsEndpoint:
    ...
    def test_metrics_without_training(self, client):
    ...
    def test_metrics_after_training(self, client, sample_training_params):
...
class TestOptimizeEndpoint:
    ...
    def test_optimize_without_optuna(self, client):
    ...
    @pytest.mark.slow
    def test_optimize_random_forest(self, client, sample_training_params):
    ...
    def test_optimize_invalid_model(self, client):
        """Test optimize with invalid model name"""
        response = client.post("/optimize", params={"model_name": "invalid_model", "n_trials": 5})
...
class TestVisualizationEndpoints:
    ...
    def test_model_comparison_without_training(self, client):
    ...
    def test_model_comparison_after_training(self, client, sample_training_params):
    ...
    def test_confusion_matrix_without_training(self, client):
    ...
    def test_roc_curve_without_training(self, client):
        """Test ROC curve when no models trained"""
        response = client.get("/visualizations/roc-curve/random_forest")
        # May return 404, 500, or handle gracefully
        assert response.status_code in [
            status.HTTP_404_NOT_FOUND,
            status.HTTP_500_INTERNAL_SERVER_ERROR,
            status.HTTP_200_OK
    ...
    def test_roc_curve_after_training(self, client, sample_training_params):
        ...
        if response.status_code == status.HTTP_200_OK:
            ...
            response = client.get("/visualizations/all/random_forest")
            assert response.status_code == status.HTTP_200_OK
            data = response.json()
            assert "roc_curve" in data
    
    def test_feature_importance_without_training(self, client):
    ...
    def test_all_visualizations_endpoint(self, client, sample_training_params):
...
class TestMLflowEndpoints:
    ...
    def test_mlflow_experiments_endpoint(self, client):
    ...
    def test_mlflow_runs_endpoint(self, client):
        """Test MLflow runs endpoint"""
        response = client.get("/mlflow/runs")
